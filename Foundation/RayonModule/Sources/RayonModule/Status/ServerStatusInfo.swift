...
public class ServerStatus: ObservableObject, Equatable {
    ...
    /// 服务器 CPU 信息
    public struct ProcessorInfo: Codable, Equatable, Identifiable {
        public var id = UUID()
    ...
    /// 服务器 CPU 信息 这里全部是百分比
    public struct ProcessPercentInfo: Codable, Equatable, Identifiable {
        public var id = UUID()
    ...
    /// 服务器 CPU 的立即信息
    public struct ProcessInfoElement: Codable, Equatable, Identifiable {
        public var id = UUID()
    ...
    /// 服务器 RAM 信息
    public struct MemoryInfo: Codable, Equatable, Identifiable {
        public var id = UUID()
    ...
    /// 服务器 NET 信息
    public struct NetworkInfo: Codable, Equatable, Hashable, Identifiable {
        public var id = UUID()
    ...
    /// 服务器 文件系统 信息
    public struct FileSystemInfo: Codable, Equatable, Hashable, Identifiable {
        public var id = UUID()
    ...
    /// 服务器 系统 信息
    public struct SystemInfo: Codable, Equatable, Hashable, Identifiable {
        public var id = UUID()
    ...
    public struct SystemLoadInternal: Codable, Equatable, Hashable, Identifiable {
        public var id = UUID()
    ...
    /// 服务器 GPU 信息
    public struct GraphicsInfo: Codable, Equatable, Identifiable, DynamicNodeEncoding {
        public var id = UUID()
    ...
    /// 单块 GPU 信息
    public struct SingleGraphicsInfo: Codable, Equatable, Identifiable {
        public var id = UUID()
        ...
        public struct Memory: Codable {
            ...
            public init(total: Float, used: Float, free: Float) {
                self.total = total
                self.used = used
                self.free = free
            }
